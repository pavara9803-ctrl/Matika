...
const citta121Data = {
  ...
  kamaKusala8Full: {
    ...
    desc: "<p class='mb-3 text-slate-600 dark:text-slate-400'>කාම සෝභන කුසල් සිත් 8 කි.</p>" +
  ...
  kamaVipaka8Full: {
    ...
    desc: "<p class='mb-3 text-slate-600 dark:text-slate-400'>කාම සෝභන විපාක සිත් 8 කි.</p>" +
          "<div class='grid grid-cols-1 sm:grid-cols-2 gap-2'>" +
          [1,2,3,4,5,6,7,8].map(i => {
            const feelings = i <= 4 ? 'සෝමනස්ස' : 'උපේක්ෂා';
            const nana = (i % 2 === 1) ? 'සම්පයුත්ත' : 'විප්පයුත්ත';
...
const cittaData = [
  ...
  },
  {
    ...
    items: [
      { name: "ලෝභ මූලික සිත් 8", meaning: "ලෝභයෙන් හා මෝහයෙන් යුක්තව උපදින සිත්", role: "සෝමනස්ස/උපේක්ෂා සහගත, දිට්ඨිගත සම්පයුත්ත/විප්පයුත්ත, සසංඛාරික/අසංඛාරික" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "කුසල අහේතුක විපාක සිත් 8", meaning: "කුසල කර්මයන්ගේ විපාක වශයෙන් උපදින සිත්", role: "චක්ඛු, සෝත, ඝාන, ජිව්හා, කාය, සම්පටිච්ඡන, සන්තීරණ (සෝමනස්ස/උපේක්ෂා)" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "කාම සෝභන ක්‍රියා සිත්", meaning: "සෝමනස්ස සහගත හා උපේක්ෂා සහගත ක්‍රියා සිත්", role: "8" },
