...
// PDF: සුත්තන්ත මාතිකා - 42 දුකයන් අනුව නිවැරදි කරන ලදී
// ආයතන/ධාතු ගණන නිවැරදිව දක්වා ඇත (උදා: 2/12, 2/18)
...
// ============================================================
// ආයතන - සාමාන්‍ය (සියලු ආයතන 12) → 12/12
// ============================================================
...
// ============================================================
// ධාතු - සාමාන්‍ය (සියලු ධාතු 18) → 18/18
// ============================================================
function makeDhatu() {
  return [
...
// ============================================================
// ආයතන - නාම ධර්ම පමණක් (මනෝ + ධම්ම) → 2/12
// ============================================================
...
// ============================================================
// ධාතු - නාම ධර්ම පමණක් (මනෝවිඤ්ඤාණ + ධම්ම) → 2/18
// ============================================================
...
// ============================================================
// ආයතන - රූප ධර්ම පමණක් → 11/12 (නාම ආයතන හිස්)
// ============================================================
...
// ============================================================
// ධාතු - රූප ධර්ම පමණක් → 11/18 (නාම ධාතු හිස්)
// ============================================================
...
// ============================================================
// ආයතන - සිත් + චෛතසික (මනෝ + ධම්ම) → 2/12
// ============================================================
...
// ============================================================
// ආයතන - රූප + සිත් + චෛතසික (සියල්ල) → 12/12
// ============================================================
...
// ============================================================
// සුත්තන්ත මාතිකා දත්ත - PDF අනුව නිවැරදි කරන ලදී
// ============================================================
...
var suttantaFullData = [
    ...
    padas: [
      {
        ...
        skandha: makeSkandha('වචී විඤ්ඤත්ති රූපය', 'නැත', 'නැත', 'නැත', 'නැත'),
        ayatana: makeAyatanaForNamaOnly('-', 'සද්දායතන + ධම්මායතන'),
        dhatu: makeDhatuForNamaOnly('-', 'සද්දධාතු + ධම්මධාතු'),
        sathya: makeSathya([{num:1,name:'දුක්ඛ සත්‍යය',value:'වචී විඤ්ඤත්ති'},{num:2,name:'සමුදය සත්‍යය',value:'-'},{num:3,name:'නිරෝධ සත්‍යය',value:'-'},{num:4,name:'මාර්ග සත්‍යය',value:'-'}])
      },
      {
        name: 'අනධිවචනපථා ධම්මා',
        desc: 'අනධිවචනපථ ධර්ම.',
        svartha: 'අනධිවචනපථා ධම්මා - අධිවචන ප්‍රඥප්තියට හේතු වූ අර්ථ ප්‍රඥප්ති නම් වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: පහකි.\nආයතන වශයෙන්: 12/12.\nධාතු වශයෙන්: 18/18.\nආර්ය සතය වශයෙන්: සතරකි.',
        skandha: makeSkandha('රූප 28', 'වේදනා චෛතසිකය', 'සඤ්ඤා චෛතසිකය', 'සංඛාර චෛතසික 50', 'සිත් 89'),
        ayatana: makeAyatana(),
        dhatu: makeDhatu(),
        sathya: makeSathya([
  ...
  // ============================================================
  {
    ...
    padas: [
      ...
      {
        name: 'නිරුත්තිපථා ධම්මා',
        desc: 'නිරුත්තිපථ ධර්ම.',
        svartha: 'නිරුත්තිපථා ධම්මා - නිරුත්ති ප්‍රඥප්තියට හේතු වූ අර්ථ ප්‍රඥප්ති නම් වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: පහකි.\nආයතන වශයෙන්: 12/12.\nධාතු වශයෙන්: 18/18.\nආර්ය සතය වශයෙන්: සතරකි.',
        skandha: makeSkandha('රූප 28', 'වේදනා චෛතසිකය', 'සඤ්ඤා චෛතසිකය', 'සංඛාර චෛතසික 50', 'සිත් 89'),
        ayatana: makeAyatana(),
        dhatu: makeDhatu(),
        sathya: makeSathya([
  ...
  // ============================================================
  {
    ...
    padas: [
      ...
      {
        name: 'පඤ්ඤත්තිපථා ධම්මා',
        desc: 'ප්‍රඥප්තිපථ ධර්ම.',
        svartha: 'පඤ්ඤත්තිපථා ධම්මා - ප්‍රඥප්ති ප්‍රඥප්තියට හේතු වූ අර්ථ ප්‍රඥප්ති නම් වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: පහකි.\nආයතන වශයෙන්: 12/12.\nධාතු වශයෙන්: 18/18.\nආර්ය සතය වශයෙන්: සතරකි.',
        skandha: makeSkandha('රූප 28', 'වේදනා චෛතසිකය', 'සඤ්ඤා චෛතසිකය', 'සංඛාර චෛතසික 50', 'සිත් 89'),
        ayatana: makeAyatana(),
        dhatu: makeDhatu(),
        sathya: makeSathya([
  ...
  // ============================================================
  {
    ...
    padas: [
      ...
      },
      {
        name: 'තණ්හා ධම්මා',
        desc: 'තණ්හා ධර්ම.',
        svartha: 'තණ්හා ධම්මා - තණ්හා වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: සංස්කාරස්කන්ධය.\nආයතන වශයෙන්: 1/12.\nධාතු වශයෙන්: 1/18.\nආර්ය සතය වශයෙන්: සමුදය සතයය.',
        skandha: makeSkandha('නැත', 'නැත', 'නැත', 'ලෝභ චෛතසිකය', 'නැත'),
        ayatana: makeAyatanaForCittaCetasika('-', 'ලෝභ චෛතසිකය'),
        dhatu: makeDhatuForCittaCetasika('-', 'ලෝභ චෛතසිකය', '-'),
        sathya: makeSathya([{num:1,name:'දුක්ඛ සත්‍යය',value:'-'},{num:2,name:'සමුදය සත්‍යය',value:'ලෝභ'},{num:3,name:'නිරෝධ සත්‍යය',value:'-'},{num:4,name:'මාර්ග සත්‍යය',value:'-'}])
      }
    ]
  },
  // ============================================================
  ...
  // ============================================================
  {
    title: '11. භවදිට්ඨි දුකය',
    padas: [
      {
        name: 'භවදිට්ඨි ධම්මා',
        desc: 'භවදෘෂ්ටි ධර්ම.',
        svartha: 'භවදිට්ඨි ධම්මා - ශාස්වත දෘෂ්ටි වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: සංස්කාරස්කන්ධය.\nආයතන වශයෙන්: 1/12.\nධාතු වශයෙන්: 1/18.\nආර්ය සතය වශයෙන්: සමුදය සතයය.',
      ...
      {
        name: 'විභවදිට්ඨි ධම්මා',
        desc: 'විභවදෘෂ්ටි ධර්ම.',
        svartha: 'විභවදිට්ඨි ධම්මා - උච්ඡේද දෘෂ්ටි වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: සංස්කාරස්කන්ධය.\nආයතන වශයෙන්: 1/12.\nධාතු වශයෙන්: 1/18.\nආර්ය සතය වශයෙන්: සමුදය සතයය.',
        skandha: makeSkandha('නැත', 'නැත', 'නැත', 'දිට්ඨි චෛතසිකය', 'නැත'),
        ayatana: makeAyatanaForCittaCetasika('-', 'දිට්ඨි චෛතසිකය'),
        dhatu: makeDhatuForCittaCetasika('-', 'දිට්ඨි චෛතසිකය', '-'),
        sathya: makeSathya([{num:1,name:'දුක්ඛ සත්‍යය',value:'-'},{num:2,name:'සමුදය සත්‍යය',value:'දිට්ඨි'},{num:3,name:'නිරෝධ සත්‍යය',value:'-'},{num:4,name:'මාර්ග සත්‍යය',value:'-'}])
  ...
  // ============================================================
  {
    ...
    padas: [
      ...
      {
        name: 'උච්ඡේදදිට්ඨි ධම්මා',
        desc: 'උච්ඡේද දෘෂ්ටි ධර්ම.',
        svartha: 'උච්ඡේදදිට්ඨි ධම්මා - උච්ඡේද දෘෂ්ටි වූ නිස්සත්ව නිජ්ජීව පරමාර්ථ ස්වභාව ධර්මයෝ ඇත්තාහ.\n\nස්කන්ධ වශයෙන්: සංස්කාරස්කන්ධය.\nආයතන වශයෙන්: 1/12.\nධාතු වශයෙන්: 1/18.\nආර්ය සතය වශයෙන්: සමුදය සතයය.',
        skandha: makeSkandha('නැත', 'නැත', 'නැත', 'දිට්ඨි චෛතසිකය', 'නැත'),
        ayatana: makeAyatanaForCittaCetasika('-', 'දිට්ඨි චෛතසිකය'),
        dhatu: makeDhatuForCittaCetasika('-', 'දිට්ඨි චෛතසිකය', '-'),
        sathya: makeSathya([{num:1,name:'දුක්ඛ සත්‍යය',value:'-'},{num:2,name:'සමුදය සත්‍යය',value:'දිට්ඨි'},{num:3,name:'නිරෝධ සත්‍යය',value:'-'},{num:4,name:'මාර්ග සත්‍යය',value:'-'}])
  ...
  // ============================================================
  // 13. අන්තවාදිට්ඨි දුකය
  // ============================================================
  {
    title: '13. අන්තවාදිට්ඨි දුකය',
    padas: [
      {
  ...
  // ============================================================
  // 14. පුබ්බන්තානුදිට්ඨි දුකය
  // ============================================================
  {
    title: '14. පුබ්බන්තානුදිට්ඨි දුකය',
    padas: [
      {
  ...
  // ============================================================
  // 25. සඤ්ඤාවේදයිතසංඛාර දුකය
  // ============================================================
  {
    title: '25. සඤ්ඤාවේදයිතසංඛාර දුකය',
    padas: [
      {
  ...
  // ============================================================
  // 30. සඤ්ඤාවේදයිත දුකය (2)
  // ============================================================
  {
    title: '30. සඤ්ඤාවේදයිත දුකය (2)',
    padas: [
      {
        name: 'සඤ්ඤාවේදයිත ධම්මා',
        desc: 'සංඥාවේදයිත ධර්ම.',
  ...
  // ============================================================
  // 32. සඤ්ඤාවේදයිතසංඛාර දුකය (2)
  // ============================================================
  {
    title: '32. සඤ්ඤාවේදයිතසංඛාර දුකය (2)',
    padas: [
      {
        name: 'සඤ්ඤාවේදයිතසංඛාර ධම්මා',
        desc: 'සංඥාවේදයිතසංස්කාර ධර්ම.',
  ...
  // ============================================================
  // 34. විඤ්ඤාණවේදයිත දුකය
  // ============================================================
  {
    title: '34. විඤ්ඤාණවේදයිත දුකය',
    padas: [
      {
  ...
  // ============================================================
  // 35. විඤ්ඤාණසංඛාර දුකය
  // ============================================================
  {
    title: '35. විඤ්ඤාණසංඛාර දුකය',
    padas: [
      {
  ...
  // ============================================================
  // 36. විඤ්ඤාණවේදයිතසංඛාර දුකය
  // ============================================================
  {
    title: '36. විඤ්ඤාණවේදයිතසංඛාර දුකය',
    padas: [
      {
